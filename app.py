...
def video_feed():
    global video
    return Response(gener(cam0),mimetype='multipart/x-mixed-replace;boundary=frame')



@app.route('/checker_feed')
def checker_feed():
    global noOfpeople
    if(noOfpeople==0):
          return send_file("static/ddd.jpg", mimetype='image/jpg')
    else:
          return send_file("static/dss.jpg", mimetype='image/jpg')
